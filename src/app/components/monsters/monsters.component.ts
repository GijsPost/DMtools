...
export class MonstersComponent {
    ...
    public sortables: string[] = ['name', 'custom', 'challenge_rating', 'strength', 'dexterity', 'constitution', 'wisdom', 'intelligence', 'charisma', 'armor_class', 'alignment', 'hit_points', 'size', 'speed', 'type'];
